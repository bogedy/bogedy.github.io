...
* @param {any} js_obj
*/
export function print_obj(js_obj) {
    wasm.print_obj(addHeapObject(js_obj));
}
...
*/
export function test_draw(ctx) {
    try {
        wasm.test_draw(addBorrowedObject(ctx));
    } finally {
...
export class Game {
    ...
    */
    get board() {
        const ret = wasm.__wbg_get_game_board(this.__wbg_ptr);
    ...
    */
    set board(arg0) {
        ...
        wasm.__wbg_set_game_board(this.__wbg_ptr, ptr0);
    }
    /**
    * @param {CanvasRenderingContext2D} ctx
    ...
    * @returns {Game}
    */
    static new(ctx, block_pixel_size, block_width, block_height) {
        try {
            const ret = wasm.game_new(addBorrowedObject(ctx), block_pixel_size, block_width, block_height);
    ...
    */
    step(ctx, key) {
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            wasm.game_step(this.__wbg_ptr, addBorrowedObject(ctx), ptr0, len0);
        } finally {
            heap[stack_pointer++] = undefined;
        }
    }
    ...
    */
    get_gameover() {
        const ret = wasm.game_get_gameover(this.__wbg_ptr);
        return ret !== 0;
    }
}
